...
function shareThis(data, tab){
		switch(data.menuItemId){
			...
			break;
			case 'page':
			chrome.windows.create({url: "https://twitter.com/intent/tweet?url="+encodeURIComponent(tab.url)+"&text="+encodeURIComponent(tab.title), type:"panel"});
			break;
